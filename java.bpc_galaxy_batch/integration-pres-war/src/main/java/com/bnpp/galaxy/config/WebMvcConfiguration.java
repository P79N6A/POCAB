package com.bnpp.galaxy.config;

import com.bpc.sp.saf.saml.config.MvcConfig;
import com.bpc.sp.saf.saml.config.WebSecurityConfig;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    /**
     * @param filter the error page filter
     * @return filter registration filter
     */
    @Bean
    ...
    /**
     * Instanciate the multipartResolver.
     *
     * @return the set-uped multipartResolver.
     */
    @Bean
    public CommonsMultipartResolver multipartResolver() {
        LOGGER.info("Set up Multipart resolver.");
        CommonsMultipartResolver resolver = new CommonsMultipartResolver();
        resolver.setMaxUploadSize(-1); // set the size limit
        return resolver;
    }
}
