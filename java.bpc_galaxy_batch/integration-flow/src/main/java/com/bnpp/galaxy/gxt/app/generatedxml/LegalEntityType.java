 ...
 * Personne Morale
 * 
 * <p>Classe Java pour LegalEntityType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="CorprteName" type="{}Name"/>
 *         &lt;element name="LegalForm" type="{}LegalFormCode" minOccurs="0"/>
 *         &lt;element name="LegalRegstrtn" type="{}STDIdentificationInformationType" maxOccurs="unbounded" minOccurs="0"/>
...
public class LegalEntityType {
    ...
    @XmlElement(name = "CorprteName", required = true)
    protected String corprteName;
    @XmlElement(name = "LegalForm")
    protected String legalForm;
    @XmlElement(name = "LegalRegstrtn")
    protected List<STDIdentificationInformationType> legalRegstrtn;
     ...
     * 
     */
    public List<STDIdentificationInformationType> getLegalRegstrtn() {
        if (legalRegstrtn == null) {
            legalRegstrtn = new ArrayList<STDIdentificationInformationType>();
        }
