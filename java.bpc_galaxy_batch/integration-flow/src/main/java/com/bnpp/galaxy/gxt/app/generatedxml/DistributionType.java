...
/**
 * R�partition entre les supports
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="UndrlyngIdntfctn" type="{}UnderlyingIdentificationType"/>
 ...
 *         &lt;choice minOccurs="0">
 *           &lt;element name="DistrbtnRate" type="{}PercentageRate"/>
 *           &lt;element name="DistrbtnAmnt" type="{}CurrencyAndAmount"/>
 *           &lt;element name="UnitNumb" type="{http://www.w3.org/2001/XMLSchema}double"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class DistributionType {
    ...
    @XmlElement(name = "UndrlyngIdntfctn", required = true)
    protected UnderlyingIdentificationType undrlyngIdntfctn;
     ...
     * @return
     *     possible object is
     *     {@link UnderlyingIdentificationType }
     *     
     */
    public UnderlyingIdentificationType getUndrlyngIdntfctn() {
     ...
     *     
     */
    public void setUndrlyngIdntfctn(UnderlyingIdentificationType value) {
