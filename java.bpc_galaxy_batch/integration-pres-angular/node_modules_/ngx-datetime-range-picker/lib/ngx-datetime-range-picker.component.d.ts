...
import { CalendarSides, NgxDatetimeRangePickerModelItem, NgxDatetimeRangePickerOptions, NgxDatetimeRangePickerSettings } from "./interfaces/index";
export declare class NgxDatetimeRangePickerComponent implements OnChanges {
    element: ElementRef;
    private renderer;
    private ngxDateTimeRangePickerService;
    options: NgxDatetimeRangePickerOptions;
    settings: NgxDatetimeRangePickerSettings;
    optionService: Observable<any>;
    dateRangeModel: Object;
    canBeEmpty: boolean;
    dateRangeModelChange: EventEmitter<Object>;
    dateRangeChanged: EventEmitter<NgxDatetimeRangePickerModelItem>;
    ...
    constructor(element: ElementRef, renderer: Renderer, ngxDateTimeRangePickerService: NgxDatetimeRangePickerService);
    ...
    getDatecharacteristics(date: any, month: any, side: any): {
        available: boolean;
        inRange: boolean;
        active: boolean;
        today: boolean;
    ...
    generateCalendar(date: any, side: any): {
        label: string;
        months: any[];
        years: any[];
        itemRows: Object[];
    };
    generateTimePicker(time: any, side: any): {
        hour: any[];
        minute: any[];
        meridian: any[];
    };
    ...
    getNgxDatetimeRangePickerModelItem(format?: any): NgxDatetimeRangePickerModelItem;
    doApply(): void;
