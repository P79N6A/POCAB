...
export declare class NgxDatetimeRangePickerService {
    ...
    isDateAvailable(date: any, minDate: any, maxDate: any, startDate: any, endDate: any, monthStartDate: any, monthEndDate: any, config: any): boolean;
    isDateInRange(date: any, minDate: any, maxDate: any, startDate: any, endDate: any, monthStartDate: any, monthEndDate: any, available: any, config: any): boolean;
    ...
    getFirstLastDay(date: any, type: any): {
        firstDay: string;
        lastDay: string;
    };
