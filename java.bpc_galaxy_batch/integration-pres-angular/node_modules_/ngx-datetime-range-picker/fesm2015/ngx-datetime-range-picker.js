...
import { defineInjectable, Injectable, EventEmitter, Input, Output, ViewChild, Component, ViewEncapsulation, ElementRef, Renderer, NgModule, Pipe, Optional, SkipSelf } from '@angular/core';
...
const EU_TZ_CODE$1 = NgxDatetimeRangePickerConstants.CONSTANT.EU_TZ_CODE;
...
let NgxDatetimeRangePickerService = class NgxDatetimeRangePickerService {
    ...
    getSanitizedDateArray(config) {
        ...
        _.forEach(dateArray, (date) => {
            if (date) {
                ...
                let value = format ? moment$1(date, format).format(format) : moment$1(date).valueOf();
                if (type === "weekly") {
                    value = format
    ...
    getNumberOfWeeks(date) {
        ...
        if (date) {
            const monthStart = moment$1(date, DEFAULT_DATE_FROMAT)
                .startOf("month")
                .day();
            const monthEnd = Number(moment$1(date, DEFAULT_DATE_FROMAT)
                .endOf("month")
                .format("D"));
    ...
    getYearlyWeekCount(year, retailCalendar) {
        ...
        if (year) {
            ...
            const yearEndDate = moment$1(year, "YYYY")
                .endOf("year")
                .format(DEFAULT_DATE_FROMAT);
            const yearEndWeekEndDate = moment$1(yearEndDate, DEFAULT_DATE_FROMAT)
                .startOf("week")
                .format(DEFAULT_DATE_FROMAT);
            const yearStartWeekEndDate = moment$1(yearStartDate, DEFAULT_DATE_FROMAT)
                .endOf("week")
                .format(DEFAULT_DATE_FROMAT);
    ...
    getMonthsAvailable(minDate, maxDate, selectedYear) {
        ...
        if (minDate && maxDate && selectedYear) {
            let minDatems = moment$1(minDate, DEFAULT_DATE_FROMAT).valueOf();
            let maxDatems = moment$1(maxDate, DEFAULT_DATE_FROMAT).valueOf();
    ...
    isDateToday(date, config) {
        let today = false;
        const todayDate = moment$1()
            .startOf("day")
            .valueOf();
        const type = config.type;
        const firstLastDay = this.getFirstLastDay(moment$1(todayDate).format(DEFAULT_DATE_FROMAT), type);
        const firstDay = moment$1(firstLastDay.firstDay, DEFAULT_DATE_FROMAT).valueOf();
        const lastDay = moment$1(firstLastDay.lastDay, DEFAULT_DATE_FROMAT).valueOf();
        ...
        if (type === "daily") {
            if (!_.isNil(monthStartWeekNumber) && !_.isNil(dateRows) && !_.isNil(year)) {
                const yearStartDateDaily = moment$1()
                    ...
                    .startOf("year")
                    .format(DEFAULT_DATE_FROMAT);
                currentItemDate = moment$1(yearStartDateDaily, DEFAULT_DATE_FROMAT)
...
NgxDatetimeRangePickerService.ngInjectableDef = defineInjectable({ factory: function NgxDatetimeRangePickerService_Factory() { return new NgxDatetimeRangePickerService(); }, token: NgxDatetimeRangePickerService, providedIn: "root" });
NgxDatetimeRangePickerService = __decorate([
    Injectable({
        providedIn: "root"
    })
...
const DEFAULT_DATE_FROMAT$1 = NgxDatetimeRangePickerConstants.DEFAULT.DATE_FROMAT;
const DEFAULT_TIME_FORMAT$1 = NgxDatetimeRangePickerConstants.DEFAULT.TIME_FORMAT;
const DEFAULT_START_DATE$1 = NgxDatetimeRangePickerConstants.DEFAULT.START_DATE;
const DEFAULT_END_DATE$1 = NgxDatetimeRangePickerConstants.DEFAULT.END_DATE;
const DEFAULT_MIN_DATE$1 = NgxDatetimeRangePickerConstants.DEFAULT.MIN_DATE;
const DEFAULT_MAX_DATE$1 = NgxDatetimeRangePickerConstants.DEFAULT.MAX_DATE;
const DEFAULT_START_TIME$1 = NgxDatetimeRangePickerConstants.DEFAULT.START_TIME;
const DEFAULT_END_TIME$1 = NgxDatetimeRangePickerConstants.DEFAULT.END_TIME;
...
let NgxDatetimeRangePickerComponent = class NgxDatetimeRangePickerComponent {
    ...
    isPrevAvailale(month) {
        const minDate = this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.minDate, DEFAULT_DATE_FROMAT$1);
        const currentMonthStartDate = moment$2(month, "MMM YYYY")
            .startOf("month")
            .valueOf();
    ...
    isNextAvailale(month) {
        const maxDate = this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.maxDate, DEFAULT_DATE_FROMAT$1);
        const currentMonthEndDate = moment$2(month, "MMM YYYY")
            .endOf("month")
            .valueOf();
    ...
    getDatecharacteristics(date, month, side) {
        const currentDate = moment$2(date, DEFAULT_DATE_FROMAT$1)
            .startOf("day")
            .valueOf();
        const minDate = moment$2(this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.minDate, DEFAULT_DATE_FROMAT$1), DEFAULT_DATE_FROMAT$1)
            .startOf("day")
            .valueOf();
        const maxDate = moment$2(this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.maxDate, DEFAULT_DATE_FROMAT$1), DEFAULT_DATE_FROMAT$1)
            .startOf("day")
            .valueOf();
        const startDate = moment$2(this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.startDate, DEFAULT_DATE_FROMAT$1), DEFAULT_DATE_FROMAT$1)
            .startOf("day")
            .valueOf();
        const endDate = moment$2(this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.endDate, DEFAULT_DATE_FROMAT$1), DEFAULT_DATE_FROMAT$1)
            .startOf("day")
            .valueOf();
        const currentMonthStartDate = moment$2(month, "MMM YYYY")
            .startOf("month")
    ...
    onClickPrevious(month, side) {
        const startDate = moment$2(month, "MMM YYYY")
            .subtract(1, "month")
            .startOf("month")
    ...
    onClickNext(month, side) {
        const endDate = moment$2(month, "MMM YYYY")
            .add(1, "month")
            .endOf("month")
            .format(DEFAULT_DATE_FROMAT$1);
    ...
    onCellClick(item, itemCell, side) {
        const date = item.date ? moment$2(item.date, DEFAULT_DATE_FROMAT$1).valueOf() : item.date;
    ...
    onCellMouseEnter(item, itemCell) {
        ...
        if (!endDate) {
            _$1.forOwn(this.dates, (sideDates, side) => {
                _$1.forEach(sideDates.itemRows, (rows) => {
                    _$1.forEach(rows.items, (rowItem) => {
                        if (rowItem.available) {
                            const hoverItemDate = rowItem.date ? moment$2(rowItem.date, DEFAULT_DATE_FROMAT$1).valueOf() : rowItem.date;
    ...
    onTimeLabelChange(timeItem, side, item) {
        ...
        if (side === "left") {
            ...
            const startDateEpoch = moment$2(this.config.startDate, DEFAULT_DATE_FROMAT$1).valueOf();
            const endDateEpoch = moment$2(this.config.endDate, DEFAULT_DATE_FROMAT$1).valueOf();
    ...
    handleDateArray() {
        if (this.config.dateArray && this.config.dateArray.length > 0) {
            ...
            // sort in asc order
            this.config.dateArray = _$1.sortBy(this.config.dateArray, (date) => {
                let format = null;
                if (isNaN(Number(date))) {
                ...
                const value = moment$2(date, format).valueOf();
                if (!isNaN(value)) {
                    return value;
                }
                else {
            ...
            if (moment$2(this.config.minDate, DEFAULT_DATE_FROMAT$1).valueOf() ===
            ...
            if (moment$2(this.config.maxDate, DEFAULT_DATE_FROMAT$1).valueOf() ===
            ...
            if (moment$2(this.config.startDate, DEFAULT_DATE_FROMAT$1).valueOf() ===
            ...
            if (moment$2(this.config.endDate, DEFAULT_DATE_FROMAT$1).valueOf() ===
    ...
    sanitizeDates() {
        ...
        if (this.config.type === "weekly") {
            ...
            this.config.endDate = moment$2(this.config.endDate, DEFAULT_DATE_FROMAT$1)
                ...
                .format(DEFAULT_DATE_FROMAT$1);
            if (this.config.type === "yearly") {
                const minDate = moment$2(this.config.minDate, DEFAULT_DATE_FROMAT$1).format(DEFAULT_DATE_FROMAT$1);
                const startDate = moment$2(this.config.startDate, DEFAULT_DATE_FROMAT$1).format(DEFAULT_DATE_FROMAT$1);
    ...
    selectActiveRange() {
        _$1.forOwn(this.config.availableRanges, (rangeModel, range) => {
    ...
    generateCalendar(date, side) {
        ...
        if (this.config.type !== "yearly") {
            ...
            const monthStartWeekNumber = moment$2(date, DEFAULT_DATE_FROMAT$1)
                .year(this.selectedYear[side])
                .startOf("month")
                .week(); // previousMonthLastWeek
            const yearStartDate = moment$2(this.selectedYear[side], "YYYY")
                .startOf("year")
                .format(DEFAULT_DATE_FROMAT$1);
            let numberOfRows = 1;
            let rowNumber = 0;
    ...
    getNgxDatetimeRangePickerModelItem(format) {
        ...
        let endDate = moment$2(this.config.endDate, DEFAULT_DATE_FROMAT$1).format(outputDateFormat);
    ...
    doApply() {
        ...
        if (this.config.startDate && this.config.endDate) {
            if (!this.config.timePicker) {
                ...
                if (this.config.timePicker) {
                    _$1.forEach(this.sides, (side) => {
                        this.times[side] = this.generateTimePicker(null, side);
                    });
                }
            }
        }
        let outputStartDate = startDate ? moment$2(startDate, DEFAULT_DATE_FROMAT$1).valueOf() : null;
        let outputEndDate = endDate ? moment$2(endDate, DEFAULT_DATE_FROMAT$1).valueOf() : null;
        if (this.config.outputDateFormat) {
            outputStartDate = startDate ? moment$2(startDate, DEFAULT_DATE_FROMAT$1).format(this.config.outputDateFormat) : null;
...
NgxDatetimeRangePickerComponent = __decorate([
    Component({
...
NgxDatetimeRangePickerModule = NgxDatetimeRangePickerModule_1 = __decorate([
    NgModule({
    ...
    __metadata("design:paramtypes", [NgxDatetimeRangePickerModule])
...
export { NgxDatetimeRangePickerComponent, NgxDatetimeRangePickerModule, NgxDatetimeRangePickerService, ObjNgFor as ɵa, MaterialModule as ɵb };
