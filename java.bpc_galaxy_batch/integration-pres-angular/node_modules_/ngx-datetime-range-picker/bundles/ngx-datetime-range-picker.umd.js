(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('@angular/forms'), require('@angular/platform-browser/animations'), require('@angular/material')) :
    typeof define === 'function' && define.amd ? define('ngx-datetime-range-picker', ['exports', '@angular/core', 'rxjs', '@angular/common', '@angular/forms', '@angular/platform-browser/animations', '@angular/material'], factory) :
    (global = global || self, factory(global['ngx-datetime-range-picker'] = {}, global.ng.core, global.rxjs, global.ng.common, global.ng.forms, global.ng.platformBrowser.animations, global.ng.material));
}(this, function (exports, core, rxjs, common, forms, animations, material) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var EU_TZ_CODE$1 = NgxDatetimeRangePickerConstants.CONSTANT.EU_TZ_CODE;
    ...
    var NgxDatetimeRangePickerService = /** @class */ (function () {
        ...
        NgxDatetimeRangePickerService.prototype.getNumberOfWeeks = function (date) {
            ...
            if (date) {
                var monthStart = moment$1(date, DEFAULT_DATE_FROMAT)
                    .startOf("month")
                    .day();
                var monthEnd = Number(moment$1(date, DEFAULT_DATE_FROMAT)
                    .endOf("month")
                    .format("D"));
        ...
        NgxDatetimeRangePickerService.ngInjectableDef = core.defineInjectable({ factory: function NgxDatetimeRangePickerService_Factory() { return new NgxDatetimeRangePickerService(); }, token: NgxDatetimeRangePickerService, providedIn: "root" });
    ...
    var DEFAULT_DATE_FROMAT$1 = NgxDatetimeRangePickerConstants.DEFAULT.DATE_FROMAT;
    var DEFAULT_TIME_FORMAT$1 = NgxDatetimeRangePickerConstants.DEFAULT.TIME_FORMAT;
    var DEFAULT_START_DATE$1 = NgxDatetimeRangePickerConstants.DEFAULT.START_DATE;
    var DEFAULT_END_DATE$1 = NgxDatetimeRangePickerConstants.DEFAULT.END_DATE;
    var DEFAULT_MIN_DATE$1 = NgxDatetimeRangePickerConstants.DEFAULT.MIN_DATE;
    var DEFAULT_MAX_DATE$1 = NgxDatetimeRangePickerConstants.DEFAULT.MAX_DATE;
    var DEFAULT_START_TIME$1 = NgxDatetimeRangePickerConstants.DEFAULT.START_TIME;
    var DEFAULT_END_TIME$1 = NgxDatetimeRangePickerConstants.DEFAULT.END_TIME;
    var TZ_CODES = NgxDatetimeRangePickerConstants.CONSTANT.TZ_CODES;
    var USA_TZ_CODE$1 = NgxDatetimeRangePickerConstants.CONSTANT.USA_TZ_CODE;
    var NgxDatetimeRangePickerComponent = /** @class */ (function () {
        function NgxDatetimeRangePickerComponent(element, renderer, ngxDateTimeRangePickerService) {
            var _this = this;
        ...
        NgxDatetimeRangePickerComponent.prototype.ngOnChanges = function (changes) {
            ...
            if (changes.optionService && changes.optionService.currentValue) {
                changes.optionService.currentValue.subscribe(function (dateOptions) {
        ...
        NgxDatetimeRangePickerComponent.prototype.isPrevAvailale = function (month) {
            var minDate = this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.minDate, DEFAULT_DATE_FROMAT$1);
        ...
        NgxDatetimeRangePickerComponent.prototype.isNextAvailale = function (month) {
            var maxDate = this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.maxDate, DEFAULT_DATE_FROMAT$1);
        ...
        NgxDatetimeRangePickerComponent.prototype.getDatecharacteristics = function (date, month, side) {
            var currentDate = moment$2(date, DEFAULT_DATE_FROMAT$1)
                .startOf("day")
                .valueOf();
            var minDate = moment$2(this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.minDate, DEFAULT_DATE_FROMAT$1), DEFAULT_DATE_FROMAT$1)
                .startOf("day")
                .valueOf();
            var maxDate = moment$2(this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.maxDate, DEFAULT_DATE_FROMAT$1), DEFAULT_DATE_FROMAT$1)
                .startOf("day")
                .valueOf();
            var startDate = moment$2(this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.startDate, DEFAULT_DATE_FROMAT$1), DEFAULT_DATE_FROMAT$1)
                .startOf("day")
                .valueOf();
            var endDate = moment$2(this.ngxDateTimeRangePickerService.formatDateToDefaultFormat(this.config.endDate, DEFAULT_DATE_FROMAT$1), DEFAULT_DATE_FROMAT$1)
                .startOf("day")
                .valueOf();
            var currentMonthStartDate = moment$2(month, "MMM YYYY")
                .startOf("month")
            ...
            var currentMonthEndDate = moment$2(month, "MMM YYYY")
                ...
                .startOf("day")
                .valueOf();
            var available = this.ngxDateTimeRangePickerService.isDateAvailable(currentDate, minDate, maxDate, startDate, endDate, currentMonthStartDate, currentMonthEndDate, this.config);
            var inRange = this.ngxDateTimeRangePickerService.isDateInRange(currentDate, minDate, maxDate, startDate, endDate, currentMonthStartDate, currentMonthEndDate, available, this.config);
            var active = this.ngxDateTimeRangePickerService.isDateActive(currentDate, startDate, endDate, side);
            var today = this.ngxDateTimeRangePickerService.isDateToday(currentDate, this.config);
            // Active
        ...
        NgxDatetimeRangePickerComponent.prototype.onClickPrevious = function (month, side) {
        ...
        NgxDatetimeRangePickerComponent.prototype.onClickNext = function (month, side) {
            ...
            if (!endDate) {
                _$1.forOwn(this.dates, function (sideDates, side) {
                    _$1.forEach(sideDates.itemRows, function (rows) {
                        _$1.forEach(rows.items, function (rowItem) {
                            if (rowItem.available) {
                                var hoverItemDate = rowItem.date ? moment$2(rowItem.date, DEFAULT_DATE_FROMAT$1).valueOf() : rowItem.date;
        ...
        NgxDatetimeRangePickerComponent.prototype.onCalendarLabelChange = function (label, side, type) {
            ...
            if (this.config.type !== "yearly") {
                ...
                var startDate = this.ngxDateTimeRangePickerService.formatStartDate(config, this.config.viewDateFormat);
                var endDate = this.config.endDate
        ...
        NgxDatetimeRangePickerComponent.prototype.onTimeLabelChange = function (timeItem, side, item) {
            var time = null;
            if (side === "left") {
        ...
        NgxDatetimeRangePickerComponent.prototype.generateTimePicker = function (time, side) {
            ...
            for (var h = startHour; h <= 23; h++) {
                var stringified_h = this.ngxDateTimeRangePickerService.convertToViewTimeItem(h);
                timeObject.hour.push(stringified_h);
            }
            for (var m = startMinute; m <= 59; m++) {
                var stringified_m = this.ngxDateTimeRangePickerService.convertToViewTimeItem(m);
        ...
        NgxDatetimeRangePickerComponent.prototype.capitalize = function (day) {
            return _$1.capitalize(day);
        };
        NgxDatetimeRangePickerComponent.prototype.updateInputField = function () {
            var startDate = this.ngxDateTimeRangePickerService.formatStartDate(this.config, this.config.viewDateFormat);
            var endDate = this.config.endDate
                ? moment$2(this.config.endDate, DEFAULT_DATE_FROMAT$1).format(this.config.viewDateFormat)
                : "";
            if (this.config.singleDatePicker) {
        ...
        NgxDatetimeRangePickerComponent.prototype.dateRangeSelected = function () {
            var dateRangeModel = this.getNgxDatetimeRangePickerModelItem();
            this.showCalendar = false;
            this.filterInputBox.nativeElement.classList.remove("empty-filter");
            this.doDateRangeModelChange();
        ...
        NgxDatetimeRangePickerComponent.prototype.getNgxDatetimeRangePickerModelItem = function (format) {
            var dateRangeModelItem;
            var outputDateFormat = this.config.outputDateFormat;
            if (undefined !== format) {
                outputDateFormat = format;
            }
            var startDate = this.ngxDateTimeRangePickerService.formatStartDate(this.config, outputDateFormat);
        ...
        NgxDatetimeRangePickerComponent.prototype.updateActiveItem = function () {
            var startDate = this.ngxDateTimeRangePickerService.getFirstLastDay(this.config.startDate, this.config.type);
            var endDate = this.ngxDateTimeRangePickerService.getFirstLastDay(this.config.endDate, this.config.type);
            if (this.config.type === "weekly") {
    ...
    var modules = [material.MatFormFieldModule, material.MatButtonModule, material.MatInputModule, material.MatIconModule, material.MatSelectModule];
    ...
    var ObjNgFor = /** @class */ (function () {
        ...
        ObjNgFor = __decorate([
            core.Pipe({ name: "ObjNgFor", pure: false })
        ], ObjNgFor);
        return ObjNgFor;
    }());
    ...
    var NgxDatetimeRangePickerModule = /** @class */ (function () {
        ...
        NgxDatetimeRangePickerModule = NgxDatetimeRangePickerModule_1 = __decorate([
            core.NgModule({
                ...
                imports: [common.CommonModule, animations.NoopAnimationsModule, forms.FormsModule, MaterialModule],
